...
var displayMap = function displayMap(locations) {
  console.log('TESITJERVKSDVN');
  mapboxgl.accessToken = 'pk.eyJ1Ijoic3VtaXRwYWJsYSIsImEiOiJja256MWhpbHAwMTYzMm92cmVrbWF2czVtIn0.aSuxhBXNdVmp83m8JrSXXA';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " Data updated sucessfully"));
            }
...
var stripe = Stripe('pk_test_51IlQyeIotXfTrT55vv0bCxuIU2XcVwEhnk8MHy3JBTpdxSf9yfBD19cXYt2bkEQdZUqlMcTpInWkNcyr6sKySpsH006wxuL7nv');
...
var usePasswordForm = document.querySelector('.form-user-password');
